...
var alerts_msg = document.querySelector('#success-alert');
...
var initStripe = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var stripe, card, mountStripe, paymentType, paymentForm;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_3__.loadStripe)('pk_test_51JYAh4SJtA72x2UkLjI4dU1m0mKhyOln1Nm9YAZOnqfUyQZHm5FWFS4OeFbWeaY5fqWjszfxDGS2U2U7tDgWFRdf00n7nu1apJ');

          case 2:
            stripe = _context.sent;
            card = null;

            mountStripe = function mountStripe() {
            ...
            if (paymentForm) {
              paymentForm.addEventListener('submit', function (e) {
                ...
                stripe.createToken(card).then(function (res) {
                  ...
                  placeOrder(formObject);
                })["catch"](function (res) {//console.log("res.error", res.error);
                });
              });
            }
